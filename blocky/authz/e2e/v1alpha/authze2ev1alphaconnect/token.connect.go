...
const (
	...
	TokensServiceName = "blocky.authz.e2e.v1alpha.TokensService"
)
...
const (
	...
	// RPC.
	TokensServiceIssueTokenProcedure = "/blocky.authz.e2e.v1alpha.TokensService/IssueToken"
	// TokensServiceRefreshTokenProcedure is the fully-qualified name of the TokensService's
	// RefreshToken RPC.
	TokensServiceRefreshTokenProcedure = "/blocky.authz.e2e.v1alpha.TokensService/RefreshToken"
	// TokensServiceRevokeRefreshTokenProcedure is the fully-qualified name of the TokensService's
	// RevokeRefreshToken RPC.
	TokensServiceRevokeRefreshTokenProcedure = "/blocky.authz.e2e.v1alpha.TokensService/RevokeRefreshToken"
	// TokensServiceIntrospectTokenProcedure is the fully-qualified name of the TokensService's
	// IntrospectToken RPC.
	TokensServiceIntrospectTokenProcedure = "/blocky.authz.e2e.v1alpha.TokensService/IntrospectToken"
)

// TokensServiceClient is a client for the blocky.authz.e2e.v1alpha.TokensService service.
...
// NewTokensServiceClient constructs a client for the blocky.authz.e2e.v1alpha.TokensService
...
// IssueToken calls blocky.authz.e2e.v1alpha.TokensService.IssueToken.
...
// RefreshToken calls blocky.authz.e2e.v1alpha.TokensService.RefreshToken.
...
// RevokeRefreshToken calls blocky.authz.e2e.v1alpha.TokensService.RevokeRefreshToken.
...
// IntrospectToken calls blocky.authz.e2e.v1alpha.TokensService.IntrospectToken.
...
// TokensServiceHandler is an implementation of the blocky.authz.e2e.v1alpha.TokensService service.
...
func NewTokensServiceHandler(svc TokensServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	return "/blocky.authz.e2e.v1alpha.TokensService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedTokensServiceHandler) IssueToken(context.Context, *connect_go.Request[v1alpha.IssueTokenRequest]) (*connect_go.Response[v1alpha.IssueTokenResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("blocky.authz.e2e.v1alpha.TokensService.IssueToken is not implemented"))
}
...
func (UnimplementedTokensServiceHandler) RefreshToken(context.Context, *connect_go.Request[v1alpha.RefreshTokenRequest]) (*connect_go.Response[v1alpha.RefreshTokenResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("blocky.authz.e2e.v1alpha.TokensService.RefreshToken is not implemented"))
}
...
func (UnimplementedTokensServiceHandler) RevokeRefreshToken(context.Context, *connect_go.Request[v1alpha.RevokeRefreshTokenRequest]) (*connect_go.Response[emptypb.Empty], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("blocky.authz.e2e.v1alpha.TokensService.RevokeRefreshToken is not implemented"))
}
...
func (UnimplementedTokensServiceHandler) IntrospectToken(context.Context, *connect_go.Request[v1alpha.IntrospectTokenRequest]) (*connect_go.Response[v1alpha.IntrospectTokenResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("blocky.authz.e2e.v1alpha.TokensService.IntrospectToken is not implemented"))
}
