...
const (
	...
	ClientServiceShowClientCredentialsProcedure = "/blocky.authz.unsafe.v1alpha.ClientService/ShowClientCredentials"
)
...
// NewClientServiceClient constructs a client for the blocky.authz.unsafe.v1alpha.ClientService
...
// ShowClientCredentials calls blocky.authz.unsafe.v1alpha.ClientService.ShowClientCredentials.
...
// ClientServiceHandler is an implementation of the blocky.authz.unsafe.v1alpha.ClientService
// service.
...
func NewClientServiceHandler(svc ClientServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	return "/blocky.authz.unsafe.v1alpha.ClientService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedClientServiceHandler) ShowClientCredentials(context.Context, *connect_go.Request[v1alpha.ShowClientCredentialsRequest]) (*connect_go.Response[v1alpha.ClientCredentials], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("blocky.authz.unsafe.v1alpha.ClientService.ShowClientCredentials is not implemented"))
}
