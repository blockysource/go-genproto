...
const (
	...
	// SignClaims RPC.
	SignaturesServiceSignClaimsProcedure = "/blocky.authz.unsafe.v1alpha.SignaturesService/SignClaims"
	...
	SignaturesServiceIntrospectSignatureProcedure = "/blocky.authz.unsafe.v1alpha.SignaturesService/IntrospectSignature"
)

// SignaturesServiceClient is a client for the blocky.authz.unsafe.v1alpha.SignaturesService
// service.
...
// blocky.authz.unsafe.v1alpha.SignaturesService service. By default, it uses the Connect protocol
...
// SignClaims calls blocky.authz.unsafe.v1alpha.SignaturesService.SignClaims.
...
// IntrospectSignature calls blocky.authz.unsafe.v1alpha.SignaturesService.IntrospectSignature.
...
// blocky.authz.unsafe.v1alpha.SignaturesService service.
...
func NewSignaturesServiceHandler(svc SignaturesServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	return "/blocky.authz.unsafe.v1alpha.SignaturesService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedSignaturesServiceHandler) SignClaims(context.Context, *connect_go.Request[v1alpha.SignClaimsRequest]) (*connect_go.Response[v1alpha.SignClaimsResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("blocky.authz.unsafe.v1alpha.SignaturesService.SignClaims is not implemented"))
}
...
func (UnimplementedSignaturesServiceHandler) IntrospectSignature(context.Context, *connect_go.Request[v1alpha.IntrospectSignatureRequest]) (*connect_go.Response[v1alpha.IntrospectSignatureResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("blocky.authz.unsafe.v1alpha.SignaturesService.IntrospectSignature is not implemented"))
}
