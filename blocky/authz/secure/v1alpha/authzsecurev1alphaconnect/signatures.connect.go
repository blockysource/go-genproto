...
const (
	...
	SignaturesServiceName = "blocky.authz.secure.v1alpha.SignaturesService"
)
...
const (
	...
	// SignClaims RPC.
	SignaturesServiceSignClaimsProcedure = "/blocky.authz.secure.v1alpha.SignaturesService/SignClaims"
	...
	SignaturesServiceIntrospectSignatureProcedure = "/blocky.authz.secure.v1alpha.SignaturesService/IntrospectSignature"
)

// SignaturesServiceClient is a client for the blocky.authz.secure.v1alpha.SignaturesService
// service.
...
// NewSignaturesServiceClient constructs a client for the
// blocky.authz.secure.v1alpha.SignaturesService service. By default, it uses the Connect protocol
...
// SignClaims calls blocky.authz.secure.v1alpha.SignaturesService.SignClaims.
...
// IntrospectSignature calls blocky.authz.secure.v1alpha.SignaturesService.IntrospectSignature.
...
// SignaturesServiceHandler is an implementation of the
// blocky.authz.secure.v1alpha.SignaturesService service.
...
func NewSignaturesServiceHandler(svc SignaturesServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	return "/blocky.authz.secure.v1alpha.SignaturesService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedSignaturesServiceHandler) SignClaims(context.Context, *connect_go.Request[v1alpha.SignClaimsRequest]) (*connect_go.Response[v1alpha.SignClaimsResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("blocky.authz.secure.v1alpha.SignaturesService.SignClaims is not implemented"))
}
...
func (UnimplementedSignaturesServiceHandler) IntrospectSignature(context.Context, *connect_go.Request[v1alpha.IntrospectSignatureRequest]) (*connect_go.Response[v1alpha.IntrospectSignatureResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("blocky.authz.secure.v1alpha.SignaturesService.IntrospectSignature is not implemented"))
}
