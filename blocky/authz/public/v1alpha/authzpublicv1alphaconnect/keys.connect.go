...
package authzpublicv1alphaconnect

import (
	context "context"
	errors "errors"
	v1alpha "github.com/blockysource/go-genproto/blocky/authz/public/v1alpha"
...
const (
	...
	// RPC.
	KeysServiceGetPublicKeysProcedure = "/blocky.authz.public.v1alpha.KeysService/GetPublicKeys"
)
...
// NewKeysServiceClient constructs a client for the blocky.authz.public.v1alpha.KeysService service.
...
// GetPublicKeys calls blocky.authz.public.v1alpha.KeysService.GetPublicKeys.
...
func NewKeysServiceHandler(svc KeysServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	return "/blocky.authz.public.v1alpha.KeysService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedKeysServiceHandler) GetPublicKeys(context.Context, *connect_go.Request[v1alpha.GetPublicKeysRequest]) (*connect_go.Response[v1alpha.GetPublicKeysResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("blocky.authz.public.v1alpha.KeysService.GetPublicKeys is not implemented"))
}
