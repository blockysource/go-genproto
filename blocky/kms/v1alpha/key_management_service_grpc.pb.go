...
const (
	...
	KeyManagementService_GetKeyMaterialCryptoKey_FullMethodName = "/blocky.kms.v1alpha.KeyManagementService/GetKeyMaterialCryptoKey"
...
func (c *keyManagementServiceClient) GetKeyMaterialCryptoKey(ctx context.Context, in *GetKeyMaterialRequest, opts ...grpc.CallOption) (*KeyMaterialContent, error) {
	out := new(KeyMaterialContent)
	err := c.cc.Invoke(ctx, KeyManagementService_GetKeyMaterialCryptoKey_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *keyManagementServiceClient) SignContent(ctx context.Context, in *SignContentRequest, opts ...grpc.CallOption) (*SignContentResponse, error) {
...
func (UnimplementedKeyManagementServiceServer) GetKeyMaterialCryptoKey(context.Context, *GetKeyMaterialRequest) (*KeyMaterialContent, error) {
...
func (UnimplementedKeyManagementServiceServer) SignContent(context.Context, *SignContentRequest) (*SignContentResponse, error) {
...
func _KeyManagementService_GetKeyMaterialCryptoKey_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetKeyMaterialRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(KeyManagementServiceServer).GetKeyMaterialCryptoKey(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: KeyManagementService_GetKeyMaterialCryptoKey_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(KeyManagementServiceServer).GetKeyMaterialCryptoKey(ctx, req.(*GetKeyMaterialRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var KeyManagementService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _KeyManagementService_GetKeyMaterialCryptoKey_Handler,
		},
		{
